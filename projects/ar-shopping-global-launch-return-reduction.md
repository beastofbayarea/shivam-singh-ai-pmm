...
I developed this case study to show how I would lead the work behind **AR Shopping - Global Launch and Return Reduction** from an ambiguous starting point to an evidence-based decision and an executable plan. I place it in the context of my [Microsoft experience from January 2020 to August 2022](https://github.com/beastofbayarea/shivam-singh-ai-pmm/blob/main/shivam-singh-ai-pmm.pdf).
...
I use [GOV.UK - User research for government services (2016)](https://www.gov.uk/service-manual/user-research/how-user-research-improves-service-design) to ground methodology for continuous, inclusive, outcome-focused user research. I use [W3C - Web Content Accessibility Guidelines 2.1 (2018)](https://www.w3.org/TR/2018/REC-WCAG21-20180605/) to ground accessibility standard for web and mobile interaction.

## What I would set out to accomplish

- I would research the uncertainty customers face before purchase, including scale, fit, placement, and accessibility barriers.
- I would test placement accuracy, recovery, device performance, and comprehension with diverse users.
- I would keep AR outside the critical page-load path and provide an equivalent non-AR decision path.
- I would define partner asset-quality gates and launch markets only after usability and performance evidence is available.
...
|---|---|
| I would track successful placement | I would baseline this measure, assign an owner, review it by cohort or operating segment, and connect movement to a specific decision or corrective action. |
...
| I would track accessibility conformance | I would baseline this measure, assign an owner, review it by cohort or operating segment, and connect movement to a specific decision or corrective action. |
| I would track page performance | I would baseline this measure, assign an owner, review it by cohort or operating segment, and connect movement to a specific decision or corrective action. |
| I would track product-confidence change | I would use this to judge whether the output is trustworthy enough for the next stage and to identify the failure modes that need targeted work. |
| I would track return reasons | I would use this to test whether the operating model creates durable value after implementation, risk, and support costs are included. |
...
|---|---|
| [GOV.UK - User research for government services (2016)](https://www.gov.uk/service-manual/user-research/how-user-research-improves-service-design) | I use this source to ground methodology for continuous, inclusive, outcome-focused user research. |
| [W3C - Web Content Accessibility Guidelines 2.1 (2018)](https://www.w3.org/TR/2018/REC-WCAG21-20180605/) | I use this source to ground accessibility standard for web and mobile interaction. |
